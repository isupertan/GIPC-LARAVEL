...
class DoctorCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.doctor.category.list', compact('categories'));
    }
    ...
    {
        return view('backend.doctor.category.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $request->file->store('doctorcategory', 'public');

            // Store the record, using the new file hashname which will be it's new filename identity.
            $categories                   =     new DoctorCategory;
        ...
        return redirect()->route('admin.doctor.category')->with('success','Doctor Category Has Been Added');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.doctor.category.edit', compact('category'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            ...
            $categories                   =     DoctorCategory::find($id);
            $categories->title            =     $request->title;
            $categories->image_alt        =     $request->img_alt;
            $categories->description      =     $request->description;
            $categories->meta_title       =     $request->meta_title;
        ...
        $categories->save(); // Finally, save the record.
        return redirect()->route('admin.doctor.category')->with('success','Doctor Category has been Updated');
    }
    ...
    {
        $categories = DoctorCategory::find($id);
        @unlink(public_path('storage/doctorcategory/'.$categories->image_name));
        $categories->delete();

        // return redirect()->route('admin.npost')->with('success','Service has been deleted');
        return redirect()->back()->with('success','Doctor Category Has Been Deleted');
    }
}
