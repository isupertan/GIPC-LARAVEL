...
@section('bodypart')
    ...
    <div class="row">
        <div class="col-lg-6 mx-auto">
          <form method="POST" action="{{route('admin.blogcategory.update', $category->id)}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group mt-3">
                ...
                <img style="height: 20vh" src="{{url('storage/blogcategory/'.$category->image_name)}}" class="img-thumbnail"/>
