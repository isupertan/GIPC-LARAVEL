...
@section('bodypart')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">Docotr Category</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
            <li class="breadcrumb-item active">Add Docotr Category</li>
        </ol>
    <!-- Page Body -->
    <div class="row">
        <div class="col-lg-6 mx-auto">
          <div class="card" style="padding: 15px;border:2px solid #222">
           <div class="card-header">
             <h5 class="text-center"> ADD NEW DOCTOR CATEGORY</h5>
           </div>
           <form method="POST" action="{{route('admin.doctor.category.store')}}" enctype="multipart/form-data">
            @csrf
