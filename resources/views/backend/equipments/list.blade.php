...
@section('bodypart')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">EQUIPMENT LIST</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
            <li class="breadcrumb-item active">List of Equipment</li>
        </ol>
    <!-- Page Body -->
    <div class="row">
            ...
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-6 text-right" style="text-align:right">
                    <a href="{{route('admin.equipments.add')}}" class="btn btn-success">ADD</a>
                </div>
              </div>
            </div>
                    ...
                    <!-- Image Details -->
                      <div class="card-body">
                        <div class="image-conatiner-gallery">
                          <img src="{{url('storage/equipment/'.$item->image_name)}}" class="img-fluid"/>
                        </div>
