...
@section('bodypart')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">BLOG SPONSORS</h1>
    ...
    <div class="row">
        <div class="col-lg-6 mx-auto">
          <form method="POST" action="{{route('admin.sponsor.update', $category->id)}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group mt-3">
                <label>Sponsor Image</label><br>
                <img style="height: 20vh" src="{{url('storage/sponsors/'.$category->image_name)}}" class="img-thumbnail"/>
