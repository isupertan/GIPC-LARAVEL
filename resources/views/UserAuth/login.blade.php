...
<body>
  ...
  <div class="login-box">
    <h2><img src="{{url('gipc/img/GIPC_Logo_Full_dark.png')}}" width="40%"> </h2>
    <div style="color: #fff;padding-top:20px;padding-bottom:20px;font-weight:400;text-align:center;font-size:15px;"> @include('alert.messages')</div>
    <form method="POST" action="{{ route('admin.check') }}" class="form">
     @csrf
      <div class="user-box">
